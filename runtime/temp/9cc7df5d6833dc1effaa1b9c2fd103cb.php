<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\WWW\tp\public/../application/admin/view/default/repair\edit.html";i:1526187245;s:67:"D:\WWW\tp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
    ...
    <div class="form-item">
        <label class="item-label">电话号码<span class="check-tips">（用于显示数字号码）</span></label>
        <div class="controls">
            <input type="number" class="text input-large" name="tel" value="<?php echo (isset($info['tel']) && ($info['tel'] !== '')?$info['tel']:''); ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">地址<span class="check-tips">（用于显示地址）</span></label>
        <div class="controls">
            <input type="text" class="text input-large" name="address" value="<?php echo (isset($info['address']) && ($info['address'] !== '')?$info['address']:''); ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">报修原因<span class="check-tips">（用于显示报修原因）</span></label>
        <div class="controls">
            <!-- 加载编辑器的容器 -->
            <script id="container" name="reason" type="text/plain">
            <?php echo $info['reason']; ?>
    </script>
            <!-- 配置文件 -->
            <script type="text/javascript" src="/static/static/ueditor/ueditor.config.js"></script>
            <!-- 编辑器源码文件 -->
            <script type="text/javascript" src="/static/static/ueditor/ueditor.all.js"></script>
            <!-- 实例化编辑器 -->
