...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'R%VGm&@=yD?{:~o"F4|1!Z#$H^O(+b,E2>CJckwY', //默认数据加密KEY
	'data_cache_key'=> 'R%VGm&@=yD?{:~o"F4|1!Z#$H^O(+b,E2>CJckwY',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'R%VGm&@=yD?{:~o"F4|1!Z#$H^O(+b,E2>CJckwY', //加密KEY
